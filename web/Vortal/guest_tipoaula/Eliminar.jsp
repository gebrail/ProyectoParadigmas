...
<html>
    <head>
        ...
        <title>Eliminar tipo de Aula</title>
                    ...
                    <div class="row mt">
                        <div class="col-lg-12"> 
                            <div class="form-panel">
                                <h4 class="mb"><i class="fa fa-angle-right"></i> Eliminar Tipo De Aula </h4>
                                ...
                                <form role="form" method="post" id="consultarAula" name="consultarAula">
                                    ...
                                    <button type="button" class="btn btn-success" onclick='aulaConsultado(document.getElementById("nombre").value, document.getElementById("opcion").value);'>Consultar Registro</button>
                                </form>
                                <div id="listado">
                                </div>
