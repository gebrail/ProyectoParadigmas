        ...
        <section id="container">
            ...
            <section id="main-content"> 
                ...
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> Gestion De Cursos</h3>
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="row">
                                <!-- TWITTER PANEL -->
                                <div class="col-lg-4 col-md-4 col-sm-4 mb">
                                    ...
                                    <div class="white-panel pn">
                                        ...
                                        <p><img src="../assets/img/128-128.png" class="img-circle" width="100"></p>
                                        <div class="row">
                                            <a href="Registrar.jsp"    <button type="button" class="btn btn-theme">Registrar Curso</button> </a>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 mb">
                                    ...
                                    <div class="white-panel pn">
                                        <div class="white-header">
                                            <h5>Listado Todos Los cursos</h5>
                                        </div>
                                        <p><img src="../assets/img/report-256.png" class="img-circle" width="100"></p>
                                        <div class="row">
                                            <a href="Listar.jsp"    <button type="button" class="btn btn-theme">Listar Cursos</button> </a>
