                    ...
                    <div class="row mt">
                        <div class="col-lg-12"> 
                            <div class="form-panel">
                                <h4 class="mb"><i class="fa fa-angle-right"></i>Ver Notas</h4>

                                <form role="form" id="consultarMateria" name="consultarMateria"> <!-- Formulario de Busqueda de la persona -->

                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label" >Materias Que Vez</label>
                                        <div class="col-sm-10">
                                            <select class="form-control" name="losdocum" id="losdocum" onchange="listado_grEst(document.getElementById('losdocum').value, document.getElementById('eldoctxd').value)">
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <center> <button type="button" class="btn btn-primary" onclick='listado_matest(document.getElementById("eldoctxd").value);'>Mostrar Materias</button>
                                        <button type="button" class="btn btn-primary" onclick='listado_grEst(document.getElementById("losdocum").value, document.getElementById("eldoctxd").value);'>Mostrar Grupos</button></center>
                                </form>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Ver Notas</h4>
                                            </div>
