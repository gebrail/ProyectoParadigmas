                    ...
                    <div class="row mt">
                        <div class="col-lg-12"> 
                            <div class="form-panel">
                                <h4 class="mb"><i class="fa fa-angle-right"></i> Modificar Materias </h4>
                                ...
                                <form role="form" id="consultarMateria" name="consultarMateria"> <!-- Formulario de Busqueda de la persona -->
                                    ...
                                    <button type="button" class="btn btn-success" onclick='materiaconsultado(document.getElementById("nombre").value, document.getElementById("opcion").value, document.getElementById("opcon").value);'>Consultar Registro</button>
                                </form>
                                <div id="listado">
                                </div>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary" onclick='confirmarModificarMateria(document.getElementById("nombremateria").value,document.getElementById("descripcionmateria").value);'>Guardar Cambios</button>
                                            </div>
                                        </div><!-- /.modal-content -->
                                    </div><!-- /.modal-dialog -->
                                </div><!-- /.modal -->
