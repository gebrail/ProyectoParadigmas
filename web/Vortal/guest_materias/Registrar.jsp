                    ...
                    <div class="row mt">
                        <div class="col-lg-12"> 
                            <div class="form-panel">
                                <h4 class="mb"><i class="fa fa-angle-right"></i> Registar Materia</h4>

                                <form class="form-horizontal style-form" role="form" method="post" id="registroMateria" enctype="application/x-www-form-urlencoded" name="registroMateria">
                                    <input type="hidden" id="opcion" name="opcion" value="1"/>          

                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Id del Materia</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="idmateria" name="idmateria" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">nombre de la materia</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="nombremateria" name="nombremateria">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Descripcion de la Materia</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="descripcion" name="descripcion">
                                        </div>
                                    </div>

                                    <center> <button type="button" class="btn btn-primary btn-lg" onclick="validarRegistroMateria()" >Registrar</button></center>
                                </form>
