                    ...
                    <div class="row mt">
                        <div class="col-lg-12"> 
                            <div class="form-panel">
                                <h4 class="mb"><i class="fa fa-angle-right"></i> Eliminar Cuenta</h4>

                                <!--aqui nombro el formulario como consultarpersona-->
                                <form role="form" method="post" id="consultarMateria" name="consultarMateria">
                                    ...
                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Digita el nombre del curso" required>
                                    </div>
