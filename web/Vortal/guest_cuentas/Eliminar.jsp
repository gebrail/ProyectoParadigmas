                            ...
                            <div class="form-panel">
                                ...
                                <form role="form" method="post" id="consultarpersona" name="consultarpersona">
                                    ...
                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input type="text" class="form-control" id="atributo" name="atributo" placeholder="Digita el username para buscar" required>
                                    </div>
                                    <button type="button" class="btn btn-success" onclick='consultaCuenta(document.getElementById("atributo").value, document.getElementById("opcion").value, document.getElementById("opcon").value);'>Consultar Registro</button>
                                </form>
                                <div id="listado">
                                </div>
