...
<html>
    <head>
        ...
        <title>Ver Listado De Admines</title>
    ...
    <body onload="listaradministradores()">
                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="content-panel">
                                <center>                                <h4><i class="fa fa-angle-right"></i> Listado De ADMINES</h4
                                    <div class="showback">
