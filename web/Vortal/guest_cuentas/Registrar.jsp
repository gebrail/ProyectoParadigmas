    ...
    <head>
        ...
        <script>
            function cargarAjax()
            {
                ...
                listadoroles();// este metodo me trae todos los roles creados en la base de datos
            }
        </script>
                    ...
                    <div class="row mt">
                        <div class="col-lg-12"> 
                            <div class="form-panel">
                                <h4 class="mb"><i class="fa fa-angle-right"></i> Registar Cuenta</h4>

                                <form class="form-horizontal style-form" role="form" method="post" id="registroCuenta" enctype="application/x-www-form-urlencoded" name="registroCuenta">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Tipo Rol</label>

                                        <div class="col-sm-10">
                                            <select class="form-control" id="losroles" name="losroles">
                                    ...
                                    <center> <button type="button" class="btn btn-primary btn-lg" onclick="validarRegistroCuenta();" >Registrar</button></center>
