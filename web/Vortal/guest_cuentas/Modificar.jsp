...
<html>
    <head>
        ...
        <script type="text/javascript" src="../ajax/cuentas.js"></script>
                    ...
                    <div class="row mt">
                        <div class="col-lg-12"> 
                            <div class="form-panel">
                                <h4 class="mb"><i class="fa fa-angle-right"></i> Modificar Cuenta</h4>
                                <form role="form" id="consultarCuenta" name="consultarCuenta"> <!-- Formulario de Busqueda -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="atributo" name="atributo"  placeholder="Digita el username de la cuenta" required>
                                    </div>
                                    <button type="button" class="btn btn-success" onclick='consultaCuenta(document.getElementById("atributo").value, document.getElementById("opcion").value, document.getElementById("opcon").value);'>Consultar Cuenta</button>
                                </form>
                                <div id="listado">
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary" onclick='confirmarModificarCuenta(document.getElementById("passwordxd").value);'>Guardar Cambios</button>
                                            </div>
                                        </div><!-- /.modal-content -->
                                    </div><!-- /.modal-dialog -->
                                </div>
                                ...
                                %>
                                <script>
                                    alert("A Ocurrido un error, compruebe los datos.");
                                </script>
                                <%
                                    }
                                %>
