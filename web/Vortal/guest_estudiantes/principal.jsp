                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 mb">
                                    ...
                                    <div class="white-panel pn">
                                        ...
                                        <div class="row">
                                            <a href="#"    <button type="button" class="btn btn-theme">Asignar Curso</button> </a>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 mb">
                                    ...
                                    <div class="white-panel pn">
                                        <div class="white-header">
                                            <h5>Ver Estudiantes Cuya Materias Tienen Matriculadas</h5>
                                        </div>
                                        <p><img src="../assets/img/Street-View-128.png" class="img-circle" width="100"></p>
                                        <div class="row">
                                            <a href="#"    <button type="button" class="btn btn-theme">Ver</button> </a>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 mb">
                                    ...
                                    <div class="white-panel pn">
                                        ...
                                        <div class="row">
                                            <a href="#"    <button type="button" class="btn btn-theme">Modificar Curso</button> </a>
                                        </div>
                                    </div>
                                </div><!-- /col-md-4 -->
