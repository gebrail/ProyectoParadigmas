...
<html>
    <head>
        ...
        <title>Principal De Profesores</title>
        ...
        <section id="container">
            ...
            <section id="main-content"> 
                ...
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> Gestion De Profesores</h3>
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="row">
                                <!-- TWITTER PANEL -->
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 mb">
                                    ...
                                    <div class="white-panel pn">
                                        ...
                                        <p><img src="../assets/img/academic-128.png" class="img-circle" width="100"></p>
                                        <div class="row">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 mb">
                                        ...
                                        <div class="white-panel pn">
                                            ...
                                            <center>
                                                <p><img src="../assets/img/fire.png" class="img-circle" width="100"></p></center>
                                            <div class="row">
                                                <a href="listar.jsp"    <button type="button" class="btn btn-theme">Eliminar</button> </a>
